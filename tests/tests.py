...
class TestApiPermission(TestCase):
    def setUp(self):
        ...
        createuser.user_permissions.set([Permission.objects.get(codename="add_servicegroup")])
        createuser.save()
        ...
        deleteuser.user_permissions.set([Permission.objects.get(codename="delete_servicegroup")])
        deleteuser.save()
        ...
        edituser.user_permissions.set([Permission.objects.get(codename="change_servicegroup")])
        edituser.save()
